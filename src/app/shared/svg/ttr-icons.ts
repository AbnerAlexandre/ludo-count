...
/** Inline locomotive silhouette (from public/ticket-to-ride/locomotive.svg), tinted via currentColor. */
@Component({
  selector: 'app-ttr-locomotive',
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <svg viewBox="0 0 470 470" fill="currentColor" role="img" aria-label="locomotiva">
      <path
...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <svg viewBox="0 -0.5 17 17" fill="currentColor" role="img" aria-label="trilho">
